...
public class DrugaAktivnost extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast t = Toast.makeText(getBaseContext(), "onCreate druge aktivnosti", Toast.LENGTH_SHORT);
        t.show();
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        Toast t = Toast.makeText(getBaseContext(), "onSaveInstanceState2", Toast.LENGTH_SHORT);
        t.show();
        Log.i("DrugaAktivnost", "onSaveInstanceState2");
    ...
    public void btnOpenCameraClick(View view){
